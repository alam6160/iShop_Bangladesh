                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <fieldset>
                                                            <input type="checkbox" id="checkbox_4" name="product_add"
                                                                value="1"
                                                                {{ $adminuser->product_add == 1 ? 'checked' : '' }}>
                                                            <label for="checkbox_4">Product Add</label>
                                                        </fieldset>
                                                        <fieldset>
                                                            <input type="checkbox" id="checkbox_4" name="product_view"
                                                                value="1"
                                                                {{ $adminuser->product_view == 1 ? 'checked' : '' }}>
