                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea name="meta_description" id="textarea" class="form-control"  placeholder="Textarea text">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea name="google_analytics" id="textarea" class="form-control"  placeholder="Textarea text">
