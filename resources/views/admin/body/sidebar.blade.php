  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        @php
        $brand = (auth()->guard('admin')->user()->brand == true);
...
<li class="treeview {{ ($prefix == '/setting')?'active':'' }}  ">
        ...
        <li class="{{ ($route == 'target-dates.index')? 'active':'' }}"><a href="{{ route('target-dates.index') }}"><i class="ti-more"></i>Set Time For Hot Deal</a></li>
