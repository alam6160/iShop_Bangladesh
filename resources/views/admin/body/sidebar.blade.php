...
<aside class="main-sidebar">
            ...
            <div class="ulogo">
                <a href="index.html">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <img src="{{ asset('backend/images/logo-dark.jpg') }}" alt="">
                        <h3><b>I</b>Shop</h3>
                    </div>
                </a>
            </div>
    ...
    <div class="sidebar-footer">
        <!-- item-->
        <a href="{{ route('site.setting') }}" class="link" data-toggle="tooltip" title=""
            data-original-title="Settings" aria-describedby="tooltip92529"><i class="ti-settings"></i></a>
        <!-- item-->
        <a href="{{ route('admin.profile') }}" class="link" data-toggle="tooltip" title=""
            data-original-title="Change profile"><i class="ti-user"></i></a>
        <!-- item-->
