...
<div class="panel panel-default checkout-step-01">
	...
	<form class="register-form" action="{{ route('checkout.store') }}" method="POST">
	    ...
	    <input type="text" name="shipping_name" class="form-control unicase-form-control text-input" id="exampleInputEmail1" placeholder="Full Name"  required="">
	  </div>  <!-- // end form group  -->


<div class="form-group">
	    <label class="info-title" for="exampleInputEmail1"><b>Email </b> <span>*</span></label>
	    <input type="email" name="shipping_email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" placeholder="Email"  required="">
	  </div>  <!-- // end form group  -->


<div class="form-group">
	    <label class="info-title" for="exampleInputEmail1"><b>Phone</b>  <span>*</span></label>
	    <input type="number" name="shipping_phone" class="form-control unicase-form-control text-input" id="exampleInputEmail1" placeholder="Phone"  required="">
	  </div>  <!-- // end form group  -->
...
<div class="form-group">
 ...
 <option value="{{ $item->id }}">{{ $item->division_name }}</option>
    ...
    <div class="form-group">
	 <label class="info-title" for="exampleInputEmail1">Details Address <span>*</span></label>
		...
		<div class="panel panel-default">
		    ...
		    <div class="">
				<ul class="nav nav-checkout-progress list-unstyled">
					...
					<li>
						<strong>Image: </strong>
						<img src="{{ asset($product->product_thambnail ?? '') }}" style="height: 50px; width: 50px;">
					</li>
