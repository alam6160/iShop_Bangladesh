                  ...
                  <div class="cart clearfix animate-effect">
                    <div class="action">
                      <ul class="list-unstyled">
                        ...
                        <li class="lnk"> <a data-toggle="tooltip" class="add-to-cart" id="{{ $product->id }}" onclick="addToCompare(this.id)"title="Compare"> <i class="fa fa-signal" aria-hidden="true"></i> </a> </li>
                      </ul>
                    </div>
                    <!-- /.action -->
                  </div>
