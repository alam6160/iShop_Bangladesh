...
Route::middleware(['auth:admin'])->group(function () {
    ...
    Route::prefix('setting')->group(function () {
        ...
        Route::resource('target-dates', TargetDateController::class);
    });
...
Route::get('/search/product', [IndexController::class, 'search'])->name('product.search.ajax');
Route::get('/products/price-search', [IndexController::class, 'priceSearch'])->name('products.price-search');
...
Route::get('/store-link', function () {
    Artisan::call('storage:link');
    return "storage created";
});
Route::post('/cash/order/guest', [CashController::class, 'CashOrderGuest'])->name('cash.order.guest');
